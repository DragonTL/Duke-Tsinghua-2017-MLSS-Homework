...
with tf.Session(config=config) as sess:
    if FLAGS.is_train:
        ...
        model = RNN(
                ...
                FLAGS.labels,
                embed,
                learning_rate=FLAGS.learning_rate, prob = FLAGS.prob)
